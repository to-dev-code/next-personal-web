...
const TechnicalSkillsSection = ({
  ...
  return (
    <div
      id={id}
      ref={ref}
      className="rounded-box shadow-lg flex bg-neutral-content min-w-fit gap-y-8 p-10 flex flex-col"
    >
      <div>
        ...
        <div className="flex flex-wrap gap-x-6 items-center">
          ...
          <LinkNewTab href={"https://www.typescriptlang.org/"} className="pt-1">
        ...
        <div className="flex flex-wrap gap-x-6 items-center">
          ...
          <LinkNewTab href={"https://nextjs.org/"}>
            <Tooltip direction={"bottom"} content={"NextJs"}>
              <Image
                src={"/assets/vector/nextjs-white.svg"}
                loader={() =>
                  currentTheme === "dark"
                    ? "/assets/vector/nextjs-white.svg"
                    : "/assets/vector/nextjs-black.svg"
                }
                alt={"next-logo"}
                width={100}
                height={100}
          ...
          <LinkNewTab href={"https://expressjs.com/"}>
            <Tooltip direction={"bottom"} content={"Express"}>
              <Image
                src={"/assets/vector/express-white.svg"}
                loader={() =>
                  currentTheme === "dark"
                    ? "/assets/vector/express-white.svg"
                    : "/assets/vector/express-black.svg"
                }
                alt={"express-logo"}
                width={60}
                height={60}
          ...
          <LinkNewTab href="https://tanstack.com/query/latest">
            <Tooltip direction={"bottom"} content={"Tanstack query"}>
              <div className="text-xl">
                <div>Tanstack</div>
                <div className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-amber-500 font-bold">
                  Query
                </div>
              </div>
            </Tooltip>
